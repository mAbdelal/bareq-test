/*
  ...
  - The values [buyer_rejected] on the enum `ServicePurchaseStatus` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "ServicePurchaseStatus_new" AS ENUM ('pending', 'provider_rejected', 'in_progress', 'submitted', 'disputed_by_provider', 'disputed_by_buyer', 'completed');
